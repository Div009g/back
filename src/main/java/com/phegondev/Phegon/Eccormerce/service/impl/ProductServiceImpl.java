...
public class ProductServiceImpl implements ProductService {
    ...
    public Response createProduct(Long categoryId, MultipartFile image, String name, String description, BigDecimal price) {
        ...
        String productImageUrl = null; // Default or null value for the image URL
    ...
    public Response updateProduct(Long productId, Long categoryId, MultipartFile image, String name, String description, BigDecimal price) {
        ...
        // Handle image upload or omit if not needed
        if (image != null && !image.isEmpty()) {
            // Here you might want to handle the image differently or just ignore it
            productImageUrl = null; // Set to null if you don't handle image uploads
        }
