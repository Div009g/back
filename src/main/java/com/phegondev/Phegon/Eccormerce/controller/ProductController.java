...
//        // Extract categoryId from ProductDto
//        Long categoryId = productDto.getCategory() != null ? productDto.getCategory().getId() : null;
//
//        // Call service method with categoryId and other details from ProductDto
//        return ResponseEntity.ok(productService.createProduct(categoryId, productDto.getImageUrl(), productDto.getName(), productDto.getDescription(), productDto.getPrice()));
//    }
